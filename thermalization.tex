...
\maketitle
  ...
  \subsection{ボルツマンエントロピー}
    ...
    二つの系はエネルギーと粒子を交換することができるが、それらの間の相互エネルギーは無視できるほど小さいと仮定する
\end{document}
% それぞれエクスプローラーに入力する
% pdf出力に関して
% C:\Users\kokor\.latexmkrc
% snippetsに関して
% C:\Users\kokor\AppData\Roaming\Code\User\snippets\latex.json
% hypersnipsに関して
% C:\Users\kokor\AppData\Roaming\Code\User\globalStorage\draivin.hsnips\hsnips\latex.hsnips
% chktexrcからの警告についてUserWarnRegexをコメントアウトしています。何か問題があればコメントアウトを消してください
% C:\texlive\2024\texmf-dist\chktex\chktexrc
% VScodeの設定
% C:\Users\kokor\AppData\Roaming\Code\User\settings.json
